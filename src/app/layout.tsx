    ...
    <html lang='en' suppressHydrationWarning>
      ...
      >
        {/* Pre-init stub so host apps can call window.ScxmlEditorAPI before React mounts.
            Queued calls are drained in page.tsx once the real API is ready. Script source
            lives in src/lib/host-api/pre-ready-stub.ts so tests can execute the same code. */}
